...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/owlhooter/gitian.sigs.git'])
    if not os.path.isdir('maza-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/owlhooter/maza-detached-sigs.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/owlhooter/mazacoin-new', help='Specify the URL of the repository. Default is %(default)s')

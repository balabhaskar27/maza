Maza Core version *0.15.1* is now available from:

  <https://download.litecoinca.sh/maza-0.15.1/>
...
A number of changes to the way Maza Core deals with peer connections and invalid blocks

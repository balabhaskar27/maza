...
#include <consensus/params.h>   // Maza: Hive
...
extern bool fWalletUnlockHiveMiningOnly;  // Maza: Hive: Unlock for hive mining purposes only.
...
public:
    ...
    bool IsHiveCoinBase() const { return tx->IsHiveCoinBase(); }    // Maza: Hive

    // Maza: Hive: Check if this transaction is a Bee Creation Transaction
...
// Maza: Hive: Mining optimisations: Bee range structure
struct CBeeRange
{
    std::string txid;
    std::string honeyAddress;

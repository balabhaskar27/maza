    ...
    transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("Hive bee creation"), TransactionFilterProxy::TYPE(TransactionRecord::HiveBeeCreation));         // Maza: Hive
    typeWidget->addItem(tr("Hive community fund"), TransactionFilterProxy::TYPE(TransactionRecord::HiveCommunityFund));     // Maza: Hive
    typeWidget->addItem(tr("Hivemined honey"), TransactionFilterProxy::TYPE(TransactionRecord::HiveHoney));                 // Maza: Hive

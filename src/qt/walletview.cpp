...
#include <qt/hivedialog.h>      // Maza: Hive page
...
#include <boost/thread.hpp>     // Maza: Key import helper
#include <wallet/rpcwallet.h>   // Maza: Key import helper
#include <wallet/wallet.h>      // Maza: Key import helper
#include <validation.h>         // Maza: Key import helper
...
#include <QPushButton>
#include <QVBoxLayout>
#include <QInputDialog>         // Maza: Key import helper
    ...
    platformStyle(_platformStyle)
{
    ...
    hivePage = new HiveDialog(platformStyle); // Maza: Hive page
    ...
    addWidget(hivePage);   // Maza: Hive page
...
void WalletView::setBitcoinGUI(BitcoinGUI *gui)
{
    if (gui)
    {
        ...
        // Maza: Hive: Go to hive page if bee button on overview clicked
        ...
        // Maza: Hive: Connect hive status update signal
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    hivePage->setClientModel(_clientModel); // Maza: Hive page
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    hivePage->setModel(_walletModel);         // Maza: Hive page
    ...
    if (_walletModel)
    {
		...
		// Maza: Hive: Ask for passphrase if needed hive only
...
// Maza: Hive: Unlock wallet just for hive

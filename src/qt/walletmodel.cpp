...
#include <policy/policy.h>  // Maza: Hive: For GetVirtualTransactionSize

WalletModel::WalletModel(const PlatformStyle *platformStyle, CWallet *_wallet, OptionsModel *_optionsModel, QObject *parent) :
    QObject(parent), wallet(_wallet), optionsModel(_optionsModel), addressTableModel(0),
    transactionTableModel(0),
    recentRequestsTableModel(0),
    hiveTableModel(0),  // Maza: Hive
    ...
    cachedNumBlocks(0)
{
    ...
    hiveTableModel = new HiveTableModel(platformStyle, wallet, this);  // Maza: Hive
...
WalletModel::UnlockContext WalletModel::requestUnlock(bool hiveOnly)
{
    ...
    // Maza: Hive: Support unlock for hive mining only
    ...
    return UnlockContext(this, valid, was_locked && !fWalletUnlockHiveMiningOnly); // Maza: Hive: Support unlock for hive mining only
}
